    ...
    <div className="relative my-4 mx-auto md:h-[calc(100vh_-_142px)]">
      ...
      <div className="flex items-center justify-between mb-10 w-80 md:w-96">
        ...
        <div className="flex justify-center flex-1">
          <div className="relative w-[98px] md:w-[103.46px] h-[138.56px] text-3xl">
            <div className=" rounded-[9.24px] bg-white w-[98px] md:w-[103.46px] h-[138.56px]" />
      ...
      <div className="flex items-center justify-between my-4 w-80 md:w-96">
        <div className="flex w-[98px] md:w-[103.46px] flex-col items-center justify-center flex-1">
          <div className="rounded-mini bg-dodgerblue-100 w-[98px] md:w-[103.46px] flex flex-row py-3.5 px-5 box-border items-center justify-center">
            <b className="relative">Andar</b>
          </div>
          <div className="my-2 text-xs text-center">1:2</div>
        </div>
        <div className="flex w-[98px] md:w-[103.46px] flex-col items-center justify-center flex-1">
          <div className=" rounded-mini bg-orange-200 w-[98px] md:w-[103.46px] flex flex-row py-3.5 px-5 box-border items-center justify-center">
            <b className="relative">Tie</b>
          </div>
          <div className="my-2 text-xs text-center">1:9</div>
        </div>
        <div className="flex w-[98px] md:w-[103.46px] flex-col items-center justify-center flex-1">
          <div className=" rounded-mini bg-tomato w-[98px] md:w-[103.46px] flex flex-row py-3.5 px-5 box-border items-center justify-center">
